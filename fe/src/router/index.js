...
import ViewApplicantForFinalScreening from '../views/admin/HumanResources/Applicants/ViewApplicantForFinalScreening.vue';
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            {
                                path: 'view/finalscreening/applicant/:slug',
                                name: 'finalscreeningapplicant',
                                components: {
                                    finalscreeningapplicant: ViewApplicantForFinalScreening,
                                },
                            },
                            {
                                path: 'allapplicants',
