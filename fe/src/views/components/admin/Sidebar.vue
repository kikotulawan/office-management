<template>
 <div>
  <div class="sidenav" id="admin-sidenav">
   ...
   <router-link v-if="$can('has_policies')" to="/home/human-resources/policies"><i class="bi bi-calendar-day-fill me-2 bi-3x"></i> <span class="title">Policies</span></router-link>
   <router-link v-if="$can('has_positions')" to="/home/human-resources/positions"><i class="bi bi-person-badge-fill me-2 bi-3x"></i> <span class="title">Positions</span></router-link>
