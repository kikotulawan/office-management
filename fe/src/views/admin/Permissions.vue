    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
     <div class="card pe-5 ps-5 pb-4 pt-4">
      ...
      <div class="table-responsive mt-3">
       ...
       <b-skeleton-table :rows="6" :columns="4" :table-props="{ bordered: false, striped: true }" v-if="initialLoading || isSearching"></b-skeleton-table>
       <table class="table table-hover" v-else>
        ...
        <tbody>
         <tr v-for="(role, i) in permissions.data" :key="i">
          <th scope="row" class="cursor-pointer">{{ permissions.from + i }}</th>
          <td
           class="text-nowrap cursor-pointer"
           v-on:click.prevent="
            viewdata = role;
            $bvModal.show('viewModal');
           "
          >
           {{ role.role }}
          </td>
      ...
      <div class="row mt-3" v-if="permissions.data">
       <pagination :showDisabled="true" :align="'right'" :data="permissions" @pagination-change-page="permissionsSearch">
