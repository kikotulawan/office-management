 ...
 <div>
  <div class="container-fluid">
   <div class="card p-5 mt-3 mb-5">
    ...
    <b-skeleton-table :rows="5" :columns="4" :table-props="{ bordered: true, striped: true }" class="mt-4" v-if="initialLoading"></b-skeleton-table>
      ...
      <tr v-for="(pos, i) in positions.data" :key="i">
       ...
       <td>
        <a
         ...
         @click.prevent="
          data = { ...pos };
          $bvModal.show('updatePositionModal');
         "
        >
