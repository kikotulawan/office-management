<template>
 <div>
  <div class="container-fluid">
   <div class="card p-5 mt-3 mb-5">
    ...
    <div class="d-flex justify-content-end mb-2 mt-2">
     ...
     <button class="btn btn-primary btn-sm shadow-none" @click="$bvModal.show('addJobOpeningModal')"><i class="bi bi-plus"></i>Post a Job</button>
    </div>
  ...
  <b-modal id="addJobOpeningModal" size="lg" scrollable centered title="Add Job Opening">
   <div class="row">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
     <p class="text-primary fw-bold">Job Title</p>
    </div>
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <input v-model="data.job_title" type="text" class="form-control shadow-none" placeholder="eg. Accountant" />
    </div>
   </div>
   <div class="row mt-3">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <vue-editor v-model="data.job_description" :editorToolbar="customToolbar"></vue-editor>
    </div>
   </div>
   <div class="row mt-3">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <vue-editor v-model="data.job_requirements" :editorToolbar="customToolbar"></vue-editor>
    </div>
   </div>
   <div class="row mt-3">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <div class="row">
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
       <input v-model="data.job_salary_from" type="number" class="form-control shadow-none" placeholder="from" />
      </div>
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
       <input v-model="data.job_salary_to" type="number" class="form-control shadow-none" placeholder="to" />
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="row mt-3">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <select v-model="data.job_min_experience" class="form-select shadow-none">
   ...
   <div class="row mt-3">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <select v-model="data.job_min_qualification" class="form-select shadow-none">
   ...
   <div class="row mt-3">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <vue-editor v-model="data.job_skills" :editorToolbar="customToolbar"></vue-editor>
    </div>
   </div>
   <div class="row mt-3">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <input v-model="data.job_work_location" type="text" class="form-control shadow-none" :disabled="isHomebased" />
    </div>
   </div>
   <div class="row mt-1">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <div class="form-check">
      <input v-model="isHomebased" v-on:click="isHomebasedChecked" class="form-check-input shadow-none" type="checkbox" id="flexCheckDefault" />
   ...
   <div class="row mt-3">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <input v-model="data.job_opening_expiration" type="date" class="form-control shadow-none" />
    </div>
   </div>
  ...
  <b-modal id="updateJobOpeningModal" size="lg" centered scrollable title="Update Job Opening">
   <div class="row">
    <div class="col-12 col-sm-12 col-md-4 col-lg-2 col-xl-2">
     <p>Job Title</p>
    </div>
   ...
   <div class="row mt-1">
    ...
    <div class="col-12 col-sm-12 col-md-8 col-lg-10 col-xl-10">
     <div class="form-check">
      <input v-model="isHomebased" class="form-check-input shadow-none" type="checkbox" id="flexCheckDefault" />
      <label class="form-check-label" for="flexCheckDefault">
       This is a home-based role
      </label>
     </div>
  ...
  <b-modal id="viewJobOpeningModal" centered scrollable title="View Job Opening">
   <div class="row">
    <div class="col-12">
 ...
 export default {
  ...
  methods: {
   ...
   async saveJobOpening() {
    ...
    if (this.data.job_description.trim() == '') return this.$toast.error('Job Description is required');
    if (this.data.job_requirements.trim() == '') return this.$toast.error('Job Requirements is required');
    if (this.data.job_salary_from.trim() == '') return this.$toast.error('Salary for the job is required');
    if (this.data.job_salary_to.trim() == '') return this.$toast.error('Salary for the job is required');
    if (this.data.job_type == 0) return this.$toast.error('Job Type is required');
    if (this.data.job_min_experience == 0) return this.$toast.error('Job Min. Experience is required');
    if (this.data.job_min_qualification == 0) return this.$toast.error('Job Min. Qualification is required');
    if (this.data.job_skills.trim() == '') return this.$toast.error('Job Skills is required');
    if (this.data.job_work_location.trim() == '') return this.$toast.error('Job Work Location is required');
