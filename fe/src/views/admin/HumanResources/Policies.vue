 ...
 <div>
  <div class="container-fluid">
   <div class="card p-5 mt-3 mb-5">
    ...
    <b-skeleton-table :rows="5" :columns="4" :table-props="{ bordered: true, striped: false }" class="mt-4" v-if="initialLoading"></b-skeleton-table>
      ...
      <tr v-for="(overtime, i) in overtimepolicies.data" :key="i">
       ...
       <td>
        <div class="d-flex">
         <a
          href=""
          class="btn btn-secondary btn-sm ounded-pill shadow-none me-2"
          @click.prevent="
           overtime = { ...overtime };
  ...
  <b-modal id="addPolicyModal" scrollable centered title="Add Policy">
   <form ref="policyform" class="p-2">
    ...
    <input v-model="data.grace_period" class="form-control" placeholder="per minute" type="number" />
    <label class="mt-1">Deducted Hours</label>
    <input v-model="data.deducted_hours" class="form-control" placeholder="per hour" type="number" />
   </form>
