    ...
    <nav class="job-navigation" :class="scrollpx >= 40 ? 'nav-scrolled' : ''">
      ...
      <div>
        <ul>
          <li v-if="!user">
            <router-link
              class="job-login-btn text-light me-3"
              to="/jobs/applicant/login"
              >Login Account</router-link
            >
            <router-link
              class="job-login-btn text-light"
              to="/jobs/applicant/login"
          ...
          <li v-else>
            ...
            <a
              class="job-login-btn text-light me-3"
              href=""
              v-on:click.prevent="$bvModal.show('logoutModal')"
              >Logout</a
            >
          </li>
        </ul>
      ...
      <div class="row pt-4 mb-5">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          <div class="card border-job p-5 mt-3 mb-5">
            ...
            <p>
              Salary: Php {{ data.job_salary_from }}k -
              {{ data.job_salary_to }}k
            </p>
            ...
            <p class="mt-3 fw-bold">
              ...
              <span
                class="fw-normal"
                v-html="data.job_min_qualification"
              ></span>
            </p>
            <p class="mt-3 fw-bold">
              Minimum Experience:
            ...
            <p class="mt-3 fw-bold">
              Job Type: <br /><span
                class="fw-normal"
                v-html="data.job_type"
              ></span>
            </p>
            <p class="mt-3 fw-bold">
              Job Work Location: <br /><span
                class="fw-normal"
                v-html="data.job_work_location"
              ></span>
            </p>
            <p class="mt-3">
              <span class="text-danger">Apply Until: </span
              >{{ data.job_opening_expiration | moment }}
            </p>
            <div class="d-block mt-4">
              <button
                class="btn btn-primary btn-sm"
                v-on:click.prevent="applyJob(data.id)"
              >
                Apply Now
              </button>
            </div>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-5 p-5">
          <img
            class="job-hiring-image img-fluid"
