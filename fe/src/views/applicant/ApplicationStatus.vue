<template>
 <div class="container my-5">
  <div class="card p-5 mt-3 mb-5">
   ...
   <h5 class="text-center mt-5" v-if="applicationStatus.data.length == 0 && !initialLoading">
    You have no applied job found on the database
   </h5>
   <b-skeleton-table :rows="7" :columns="6" :table-props="{ bordered: true, striped: true }" class="mt-4" v-if="initialLoading"></b-skeleton-table>
   ...
   <div class="row mt-3" v-if="applicationStatus.data">
    <pagination :showDisabled="true" :align="'right'" :data="applicationStatus" @pagination-change-page="getApplicationStaus">
